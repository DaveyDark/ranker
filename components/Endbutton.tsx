  ...
  return (
    <>
      <div className="flex items-center mt-0" onClick={handleConfetti}>
        <h1 className="bg-blue-500 p-1 rounded-3xl m-1 hover:cursor-pointer text-base font-light">
          {title}
        </h1>
        <button
          className="w-10 h-10 bg-blue-500 rounded-full hover:cursor-pointer border-0"
          ref={buttonRef}
        >
          <svg
